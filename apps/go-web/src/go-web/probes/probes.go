...
// PingBackendWithDB - probe backend service on the db acessing path
func PingBackendWithDB(w http.ResponseWriter, r *http.Request, beURL *string) {
	if *beURL == "" {
		w.WriteHeader(http.StatusOK)
		fmt.Fprintf(w, "Backend not specified")
		return
